...
class GLAttentionGeneral(nn.Module):
    ...
    def forward(self, input, sentence, context):
        ...
        # context 16, 256, 18
        idf, ih, iw = input.size(1), input.size(2), input.size(3)     # input batch x ngf feature size x image height x image width
        ...
        sourceT = self.conv_context(sourceT).squeeze(3)    # (16, 256, 18, 1) -> (16, 32, 18) this make the contiguous for the tensor https://stackoverflow.com/questions/48915810/pytorch-contiguous
