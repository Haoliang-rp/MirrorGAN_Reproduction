    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                fake_imgs, _, mu, logvar = netG(noise, sent_emb, words_embs, mask) # get the mu, logvar from the CA augmentation, and fake image from the last layer of the generative net
